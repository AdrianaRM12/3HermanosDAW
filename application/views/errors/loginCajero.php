...
<html>
	...
	<body class="homepage">
		<div id="page-wrapper">
			...
			<!-- Logo -->
                <h1 align=center>Cajer@</h1> <br><br>
                ...
                <nav id="nav">
					<ul>
                        ...
                        <center>   
							<a href= class="image featured"><img src="<?php echo base_url();?>css/images/mau.png"align="left"  /></a>
						</center>  
    ...
    <center><body>
        <div class="container">
            ...
            <div class="col-xs-12 col-md-6">
                ...
                <form action="<?php echo base_url();?>index.php/Usuario/loginCajero" method="post">
