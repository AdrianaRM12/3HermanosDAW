	<div id="footerwrap">
      	...
      	<div class="container">
      		<div class="row">
      			...
      			<p><img src="<?php echo base_url();?>css/images/logo.png" alt=""></p>
      			<p>Copyright 2016</p>
      			</div>
	...
	<script type="text/javascript" src="<?php echo base_url();?>lineandbars.js"></script>
    
	<script type="text/javascript" src="<?php echo base_url();?>js/dash-charts.js"></script>
	<script type="text/javascript" src="<?php echo base_url();?>js/gauge.js"></script>
	...
	<script type="text/javascript" src="<?php echo base_url();?>js/noty/layouts/topLeft.js"></script>
	<script type="text/javascript" src="<?php echo base_url();?>js/noty/layouts/topRight.js"></script>
