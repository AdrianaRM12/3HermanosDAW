			...
			<header id="header">
								<div class="inner">
									...
									<!-- Logo -->
                                                                        ...
                                                                        <h1 align=center>Modificar <br>Proveedor </h1> <br> <br>
                                                                        <br>
...
<form action="<?php echo base_url();?>index.php/proveedor/upProveedor" method="post">

<?php foreach ($proveedor as $pro){ ?> 

	<input type="hidden" name="id" 
	value="<?php echo $pro->id_Proveedor;?>"><br>
	
	<label><h3>Nombre: </h3></label><br>
	<input type="text" name="nombre"
		value="<?php echo $pro->Nombre;?>"><br>
	
	<label><h3>Telefono: </h3></label><br>
	<input type="text" name="tel"
		value="<?php echo $pro->Telefono;?>"><br>
		
	<label><h3>Direccion: </h3></label><br>
	<input type="text" name="direccion"
		value="<?php echo $pro->Direccion;?>"><br>

	<label><h3>id_Marca: </h3></label><br>
	<input type="text" name="idM"
		value="<?php echo $pro->id_Marca;?>"><br>
