			...
			<header id="header">
								<div class="inner">
									...
									<!-- Logo -->
                                                                        ...
                                                                        <h1 align=center>Modificar <br>Cajero </h1> <br> <br>
                                                                        <br>
...
<form action="<?php echo base_url();?>index.php/cajero/upCajero" method="post">

<?php foreach ($cajero as $caj){ ?> 

	<input type="hidden" name="id" 
	value="<?php echo $caj->id_Cajero;?>"><br>
	
	<label><h3>Nombre: </h3></label><br>
	<input type="text" name="nombre"
		value="<?php echo $caj->Nombre;?>"><br>
