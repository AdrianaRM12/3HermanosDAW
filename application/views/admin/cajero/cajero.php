			...
			<header id="header">
								<div class="inner">
									...
									<!-- Logo -->
                                                                        ...
                                                                        <h1 align=center>Administrador <br>Cajero </h1> <br> <br>
...
<table class="table table-responsive table-striped table-bordered table-hover">
    <tr>
        <td colspan="6"><a href="agrCajero">Agregar Cajero</a></td>
    </tr>
    <tr>
        <th>id_Cajero</th>
        <th>Nombre</th>
