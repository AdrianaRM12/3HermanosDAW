			...
			<header id="header">
								<div class="inner">
									...
									<!-- Logo -->
                                                                        ...
                                                                        <h1 align=center>Modificar <br>Cliente </h1> <br> <br>
                                                                        <br>
...
<?php foreach ($cliente as $client){ ?> 
	...
	value="<?php echo $client->id_Cliente;?>"><br>
	
	<label><h3>Nombre: </h3></label><br>
	<input type="text" name="nombre"
		value="<?php echo $client->Nombre;?>"><br>
	
	<label><h3>Telefono: </h3></label><br>
	<input type="text" name="telefono"
		value="<?php echo $client->Telefono;?>"><br>
		
	<label><h3>Direccion: </h3></label><br>
	<input type="text" name="direccion"
		value="<?php echo $client->Direccion;?>"><br>
