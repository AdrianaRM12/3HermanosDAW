			...
			<header id="header">
								<div class="inner">
									...
									<!-- Logo -->
                                                                        ...
                                                                        <h1 align=center>Agregar <br>Cliente </h1> <br> <br>
                                                                        <br>
...
<form action="<?php echo base_url();?>index.php/cliente/addCliente" method="post">
<h3>Nombre:</h3><input title="Escribe un NOMBRE"type="text" name="nombre"required/><br>
<h3>Telefono:</h3><input title="Escribe un TELEFONO"type="text" name="telefono"required/><br>
