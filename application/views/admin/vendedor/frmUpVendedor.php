			...
			<header id="header">
								<div class="inner">
									...
									<!-- Logo -->
                                                                        ...
                                                                        <h1 align=center>Modificar <br>Vendedor </h1> <br> <br>
                                                                        <br>
...
<form action="<?php echo base_url();?>index.php/vendedor/upVendedor" method="post">

<?php foreach ($vendedor as $vend){ ?> 

	<input type="hidden" name="id" 
	value="<?php echo $vend->id_Vendedor;?>"><br>
	
	<label><h3>Nombre: </h3></label><br>
	<input type="text" name="nombre"
		value="<?php echo $vend->Nombre;?>"><br>
