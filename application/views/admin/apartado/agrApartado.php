			...
			<header id="header">
								<div class="inner">
									...
									<!-- Logo -->
                                                                        ...
                                                                        <h1 align=center>Agregar <br>Apartado </h1> <br> <br>
                                                                        <br>
...
<form action="<?php echo base_url();?>index.php/apartado/addApartado" method="post">
<h3>Abono total:</h3><input title="Escribe un total"type="text" name="total"required/><br>
<h3>Id_Cliente:</h3><input title="Escribe un id"type="text" name="idCliente"required/><br>
