			...
			<header id="header">
								<div class="inner">
									...
									<!-- Logo -->
                                                                        ...
                                                                        <h1 align=center>Modificar <br>Categoria </h1> <br> <br>
                                                                        <br>
...
<form action="<?php echo base_url();?>index.php/categoria/upCategoria" method="post">

<?php foreach ($categoria as $cat){ ?> 

	<input type="hidden" name="id" 
	value="<?php echo $cat->id_Categoria;?>"><br>
	
	<label><h3>Nombre: </h3></label><br>
	<input type="text" name="nombre"
		value="<?php echo $cat->Nombre;?>"><br>
