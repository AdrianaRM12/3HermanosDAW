			...
			<header id="header">
								<div class="inner">
									...
									<!-- Logo -->
                                                                        ...
                                                                        <h1 align=center>Administrador <br>Categoria</h1> <br> <br>
...
<table class="table table-responsive table-striped table-bordered table-hover">
    <tr>
        <td colspan="6"><a href="agrApartado">Agregar Categoria</a></td>
    </tr>
    <tr>
