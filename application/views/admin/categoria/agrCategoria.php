			...
			<header id="header">
								<div class="inner">
									...
									<!-- Logo -->
                                                                        ...
                                                                        <h1 align=center>Agregar <br>Categoria </h1> <br> <br>
                                                                        <br>
...
<form action="<?php echo base_url();?>index.php/categoria/addCategoria" method="post">
<h3>Nombre:</h3><input title="Escribe un nombre"type="text" name="nombre"required/><br>
<h3>Descripcion:</h3><input title="Escribe una descripcion"type="text" name="descripcion"required/><br>
