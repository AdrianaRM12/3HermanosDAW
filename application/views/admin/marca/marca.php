			...
			<header id="header">
								<div class="inner">
									...
									<!-- Logo -->
                                                                        ...
                                                                        <h1 align=center>Administrador <br>Marca </h1> <br> <br>
...
<table class="table table-responsive table-striped table-bordered table-hover">
    <tr>
        <td colspan="6"><a href="agrMarca">Agregar Marca</a></td>
    </tr>
    <tr>
        <th>id_Marca</th>
        <th>Nombre</th>
