			...
			<header id="header">
								<div class="inner">
									...
									<!-- Logo -->
                                                                        ...
                                                                        <h1 align=center>Modificar <br>Marca </h1> <br> <br>
                                                                        <br>
...
<form action="<?php echo base_url();?>index.php/marca/upMarca" method="post">

<?php foreach ($marca as $marc){ ?> 

	<input type="hidden" name="id" 
	value="<?php echo $marc->id_Marca;?>"><br>
	
	<label><h3>Nombre: </h3></label><br>
	<input type="text" name="nombre"
		value="<?php echo $marc->Nombre;?>"><br>
